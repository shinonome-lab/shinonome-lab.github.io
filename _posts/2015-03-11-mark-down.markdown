...
Inline code are sur`roun`d by `backtick` key. To create a block code:
...
That's some text[^3] with a footnote.[^1]
[^3]:gjhghjg

hjkasd[dfshfgjs]("dfskjgbskdg")
